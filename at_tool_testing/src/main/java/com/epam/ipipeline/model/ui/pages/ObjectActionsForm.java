...
import com.epam.ipipeline.model.beans.ObjectAction;
import com.epam.ipipeline.model.beans.Parameter;
  ...
  private List<Parameter> getParams(WebElement actionRow) {
    ...
    actionRow.findElements(By.xpath("./div[@class='col-sm-9']//div[@class='to-oa-ap-wrapper']")).forEach(el->
        params.add(Parameter.builder()
            .name(el.getText())
            .type(el.findElement(By.xpath(".//span[contains(@class, 'badge')]")).getText())
            .build()));
    return params;
  }
